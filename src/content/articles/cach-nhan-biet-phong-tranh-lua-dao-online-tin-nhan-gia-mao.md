...
tags: ["LuaDao", "AnNinhMang", "CamNang", "BaoMat", "Internet", "CanhGiac"]
about: ["Lừa đảo online", "Tin nhắn giả mạo", "An toàn mạng"]
authorBio: "Founder LongTechVision. Chia sẻ kiến thức an toàn số thiết thực, bảo vệ người dùng Việt khỏi lừa đảo."
sourceUrl: "https://congan.gov.vn/"
sourceName: "Cảnh báo lừa đảo - Bộ Công an"
sourceDomains: "congan.gov.vn · vtv.vn"
stats:
  - { num: "Link lạ", label: "Không bấm vào đường link không rõ nguồn" }
  - { num: "OTP", label: "Không bao giờ cung cấp mã OTP cho ai" }
  - { num: "Xác minh", label: "Gọi lại số tổng đài chính thức để kiểm tra" }
  - { num: "Áp lực", label: "Cảnh giác khi bị hối thúc, đe dọa" }
  - { num: "2FA", label: "Bật xác thực 2 lớp cho tài khoản quan trọng" }
  - { num: "Lợi nhuận", label: "Nghi ngờ mọi lời hứa lợi nhuận cao bất thường" }
faq:
  - q: "Tin nhắn giả mạo ngân hàng nhận biết thế nào?"
    a: "Kẻ lừa đảo gửi tin nhắn mạo danh ngân hàng, thông báo tài khoản có vấn đề và kèm một đường link yêu cầu đăng nhập. Đường link này thường có tên miền sai lệch so với địa chỉ thật, ví dụ thêm bớt ký tự. Khi bấm vào và nhập thông tin, bạn vô tình trao tài khoản cho kẻ gian. Ngân hàng không bao giờ yêu cầu nhập mật khẩu hay OTP qua link trong tin nhắn."
  - q: "Vì sao không nên nghe theo cuộc gọi giả danh công an?"
    a: "Một chiêu phổ biến là giả danh công an, viện kiểm sát hoặc tòa án, thông báo bạn liên quan vụ án rồi đe dọa, yêu cầu chuyển tiền để chứng minh trong sạch. Cơ quan chức năng không làm việc qua điện thoại theo kiểu này và không yêu cầu chuyển tiền vào tài khoản cá nhân. Khi gặp cuộc gọi như vậy, hãy bình tĩnh cúp máy và liên hệ cơ quan công an địa phương để xác minh."
  - q: "Lừa đảo việc nhẹ lương cao hoạt động ra sao?"
    a: "Kẻ gian mời làm nhiệm vụ online đơn giản như thả tim, đặt đơn ảo để nhận hoa hồng. Vài lần đầu trả tiền thật để tạo lòng tin, sau đó dụ nạp số tiền lớn hơn rồi chiếm đoạt. Nguyên tắc là không có việc nào nhẹ nhàng mà lương cao bất thường. Bất kỳ công việc nào yêu cầu nạp tiền trước để nhận nhiệm vụ đều rất đáng ngờ."
  - q: "Nguyên tắc vàng để không bị lừa là gì?"
    a: "Ba nguyên tắc cốt lõi: không bấm vào link lạ, không cung cấp mã OTP và mật khẩu cho bất kỳ ai, và không chuyển tiền khi bị hối thúc hay đe dọa. Luôn dừng lại, kiểm chứng bằng cách gọi tới số tổng đài chính thức của ngân hàng hoặc cơ quan liên quan. Kẻ lừa đảo luôn tạo áp lực thời gian để nạn nhân không kịp suy nghĩ."
  - q: "Nếu lỡ bị lừa thì làm gì?"
    a: "Hành động nhanh. Lập tức liên hệ ngân hàng để khóa tài khoản và tạm dừng giao dịch, đổi ngay mật khẩu các tài khoản quan trọng, bật xác thực 2 lớp nếu chưa có. Giữ lại mọi bằng chứng như tin nhắn, số tài khoản, lịch sử chuyển tiền và trình báo cơ quan công an gần nhất. Báo càng sớm thì khả năng can thiệp càng cao."
related:
  - { href: "/articles/cach-bat-xac-thuc-2-lop-2fa-bao-ve-tai-khoan-chong-hack.html", cat: "Internet", title: "Cách bật xác thực 2 lớp (2FA) bảo vệ tài khoản khỏi hack" }
...
Lừa đảo trên mạng ngày càng tinh vi: tin nhắn giả mạo ngân hàng, cuộc gọi giả danh công an, lời mời việc nhẹ lương cao hay trúng thưởng bất ngờ. Chỉ một lần bấm nhầm link hay đọc mã OTP cho người lạ là có thể mất sạch tiền trong tài khoản. Bài viết tổng hợp các chiêu phổ biến, dấu hiệu nhận biết và cách phòng tránh để bảo vệ chính mình và người thân.

<div class="spec-box">
  <div class="spec-box-title">📋 Các chiêu lừa đảo phổ biến cần cảnh giác</div>
  <table>
    <tr><td>Giả mạo ngân hàng</td><td>Tin nhắn kèm link lạ đòi đăng nhập, nhập OTP</td></tr>
    <tr><td>Giả danh công an</td><td>Đe dọa liên quan vụ án, yêu cầu chuyển tiền</td></tr>
    <tr><td>Việc nhẹ lương cao</td><td>Làm nhiệm vụ online, nạp tiền rồi mất</td></tr>
    <tr><td>Trúng thưởng, quà tặng</td><td>Yêu cầu phí nhận thưởng hoặc thông tin cá nhân</td></tr>
    <tr><td>Người thân gặp nạn</td><td>Giả người quen mượn tiền gấp</td></tr>
    <tr><td>Link và app độc</td><td>Dụ cài ứng dụng ngoài để chiếm quyền máy</td></tr>
  </table>
</div>

## Những chiêu lừa đảo phổ biến nhất

Phổ biến nhất hiện nay là tin nhắn giả mạo ngân hàng. Kẻ gian gửi tin thông báo tài khoản có vấn đề kèm một đường link, dụ nạn nhân đăng nhập và nhập mã OTP. Đường link này thường có tên miền sai lệch tinh vi so với địa chỉ thật. Một khi nhập thông tin, tài khoản lập tức rơi vào tay kẻ xấu. Tương tự là chiêu giả mạo tin nhắn của các sàn thương mại hay ví điện tử.

Một nhóm khác là giả danh cơ quan chức năng. Kẻ lừa đảo đóng vai công an, viện kiểm sát hay tòa án, thông báo nạn nhân liên quan một vụ án, rồi đe dọa và yêu cầu chuyển tiền để chứng minh trong sạch. Ngoài ra còn có các chiêu việc nhẹ lương cao, làm nhiệm vụ online nhận hoa hồng, trúng thưởng đòi phí nhận quà, hay giả danh người thân gặp nạn để mượn tiền gấp.
...
## Dấu hiệu nhận biết một vụ lừa đảo

Dù chiêu thức đa dạng, các vụ lừa đảo thường có chung vài dấu hiệu. Đầu tiên là đường link lạ với tên miền sai chính tả hoặc thêm bớt ký tự so với địa chỉ chính thức. Thứ hai là lời lẽ tạo áp lực, hối thúc gấp gáp hoặc đe dọa hậu quả nghiêm trọng, nhằm khiến nạn nhân hoảng sợ và không kịp suy nghĩ.
...
<div class="art-callout">
  ✅ <strong>Ghi nhớ:</strong> Ba điều không bao giờ làm là bấm link lạ, đọc mã OTP cho người khác và chuyển tiền khi bị hối thúc. Luôn bình tĩnh, kiểm chứng qua kênh chính thức, và chia sẻ cảnh báo cho người thân để cùng phòng tránh.
</div>
